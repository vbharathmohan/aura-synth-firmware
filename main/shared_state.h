...
#define NUM_TOF_SENSORS 8 /* C-major scale: C D E F G A B C */
    ...
    static inline uint8_t instrument_to_slot(instrument_t inst)
    {
        ...
        {
        case INST_PIANO:
            return SAMPLE_SLOT_PIANO;
        case INST_STEEL_DRUM:
            return SAMPLE_SLOT_STEEL_DRUM;
        case INST_TRUMPET:
            return SAMPLE_SLOT_TRUMPET;
        case INST_808_BASS:
            return SAMPLE_SLOT_808_BASS;
        default:
            return SAMPLE_SLOT_PIANO;
        }
    }
    ...
    typedef struct
    {
        ...
        bool levels_toggle_pressed; /* Snare press edge -> toggle levels play/pause */
    } shared_state_t;
